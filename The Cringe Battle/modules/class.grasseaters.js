...
module.exports = class GrassEaters extends LivingCreature {
    ...
    move() {
        const emptCells = Math.floor(Math.random(this.chooseCell(0)));
        const emptCellsG = Math.floor(Math.random(this.chooseCell(1)));
        const emptCellsM = Math.floor(Math.random(this.chooseCell(3)));
        if (emptCells) {
